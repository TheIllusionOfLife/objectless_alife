...
(K-1)/(2n\ln 2)$, where $K$ is the number of non-zero bins in the joint
distribution and $n$ is the number of pairs. Values are clamped to $\geq 0$.
...
nonzero median MI at all densities $\geq 0.067$, while Phase~1 remains at
zero across all densities tested.}
...
median MI at all densities $\geq 0.067$, peaking near $d = 0.100$ (MI =
0.217 bits at $30 \times 30$, 90 agents) before declining at higher
densities. Phase~1 remains at zero median MI across all 12 conditions,
confirming that the Phase~2 advantage is not an artifact of the specific
grid configuration used in the main experiments.
