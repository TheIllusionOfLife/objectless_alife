...
(Cliff's $\delta = 0.34$; median-difference bootstrap 95\% CI $[0.26, 0.30]$; Table~\ref{tab:stats}),
...
Moran's $I$ reveals that the Control condition exhibits the strongest spatial
clustering (median $I = 0.124$) despite zero excess MI, while Phase~2's near-zero
median $I$ ($-0.020$) indicates that its coordination operates at the local
neighbor level rather than through large-scale spatial clustering.
