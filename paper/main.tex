...
Data/Code available at: \url{https://anonymous.4open.science/r/PLACEHOLDER}
...
confirms local coordination in Phase~2 (see the supplementary material).
...
($r \approx 0.14$), yet Phase~2 achieves substantially higher $\mathrm{MI}_{\mathrm{excess}}$.
...
Density sweep analysis, multi-seed robustness results, and algorithmic
pseudocode are available as supplementary material with the code repository.
