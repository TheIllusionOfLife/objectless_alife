...
pair-count bias ($\mathrm{MI}_{\mathrm{excess}}$ near zero at 0.050~bits, within the noise
...
MI values shown are for individual top-performing rules, not condition
...
$\mathrm{MI}_{\mathrm{excess}}$ near zero (0.050~bits, within the noise floor
...
(MI\textsubscript{excess} near zero at 0.050~bits, within the shuffle-null
noise floor).}
\label{tab:mi_summary}
\begin{tabular}{lccccc}
\toprule
Condition & Table Size & Median MI & Median MI\textsubscript{excess} & Median Adj.\ Frac.\footnotemark & Survival \\
\midrule
Random Walk & 1 (unused) & 0.910 & 0.050  & 0.364 & 100.0\% \\
Control     & 100        & 0.000 & 0.000  & 0.329 & 44.5\% \\
Phase 1     & 20         & 0.019 & 0.000  & 0.291 & 71.4\% \\
Phase 2     & 100        & 0.298 & 0.096  & 0.350 & 74.7\% \\
\bottomrule
\end{tabular}
...
For the random walk, $\mathrm{MI}_{\mathrm{excess}}$ is near zero
(0.050~bits)
...
strongest spatial clustering (median $I = 0.124$) despite zero excess MI,
...
Both controls produce $\mathrm{MI}_{\mathrm{excess}}$ significantly below
