...
final-step values for surviving rules across all four conditions.
All pairwise comparisons (Mann-Whitney $U$, Holm-Bonferroni corrected)
are significant at $p < 0.001$ for every metric.
...
The Phase~1 vs.\ Phase~2 difference is significant ($\delta = 0.185$,
$p < 10^{-42}$), confirming that richer observations support greater
role specialization.
...
significant ($\delta = 0.119$, $p < 10^{-18}$), suggesting that
Phase~2's richer observations produce slightly more dynamic temporal
trajectories.
