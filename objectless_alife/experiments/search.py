...
- ``objectless_alife.io.schemas``        – Parquet schemas & metric-name constants
- ``objectless_alife.config``            – configuration dataclasses
- ``objectless_alife.simulation.engine`` – ``run_batch_search`` engine
- ``objectless_alife.experiments``       – experiment / density-sweep / multi-seed orchestration
"""
